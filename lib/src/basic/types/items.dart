...
class Items {
  ...
  static const Item grass_path = Item.type('minecraft:grass_path');
  ...
  ///
  /// _(minecraft:piglin_brute_spawn_egg)_
  ...
  ///
  /// _(minecraft:powder_snow_bucket)_
